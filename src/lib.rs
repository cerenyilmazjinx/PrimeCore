...
#[derive(Debug)]
pub struct PrimeCoreProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PrimeCoreProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PrimeCore processing");
    
    let mut processor = PrimeCoreProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PrimeCoreProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PrimeCoreProcessor::new(false);
